...
def appopen():
    ...
    confirmbutton=ttk.Button(root,text="Press to confirm",
...
def giannisapp():
    ...
    class App():
        def __init__(self,root):
            ...
            self.frame1.grid(row=0, column=0, columnspan=3, sticky="news") # Τοποθετώ το πρώτο πλαίσιο στο παράθυρο
            self.frame2 = Frame2(self.w)
            self.frame2.grid(row=1, column=0,rowspan=2,columnspan=3, sticky="news") # Τοποθετώ το δεύτερο πλαίσιο στο παράθυρο
            self.frame3 = Frame3(self.w)
            self.frame3.grid(row=3, column=0, columnspan=3, sticky="news") # Τοποθετώ το τρίτο πλαίσιο στο παράθυρο

    class Frame1(tk.Frame):
        def __init__(self, parent):
            super().__init__(parent, bg="#e1c9f8") # Φτιάχνει το πρώτο πλαίσιο με parent widget
            self.label1 = ttk.Label(self, text="Fill in the blanks with the prevailing emotions of the day :",font=("Helvetica", 10),bootstyle="primary-inverse") # Φτιάχνει μια ταμπέλα με ένα καθορισμένο κείμενο
            self.label1.grid(row=0, column=1, columnspan=3, sticky="news",padx=125) # Τοποθετώ την ταμπέλα
            ...
            for i in range(5): # Τοποθετώ μέσα σε μια σειρά τα παρακάτω widget για να αποφύγω την επανάληψη τους 
                self.lbl = ttk.Label(self, text="•") # Δημιουργώ μια ταμπέλα με "•" σαν κείμενο
    ...
    class Frame2(tk.Frame):
        def __init__(self, parent):
            ...
            self.label2 = ttk.Label(self, text="Elaborate further on these feelings !",font=("Helvetica", 10),bootstyle="primary-inverse") # Φτιάχνει μια ταμπέλα με ένα καθορισμένο κείμενο
            self.label2.grid(row=0, column=0, columnspan=3, sticky="news",pady=2,padx=250) # Τοποθετώ την ταμπέλα
            
            self.text = ttk.Text(self,font=("Helvetica", 10), width=80, height=23) # Δημιουργώ ένα text widget, στο οποίο ο χρήστης μπορεί να πληκρολογήσει ελεύθερα τις σκέψεις του 
            self.text.grid(row=1, column=0, sticky="news", rowspan=1,columnspan=3, padx=10) # Τοποθετώ το widget
            
            self.clear_all_button = ttk.Button(self,text="Clear Text",bootstyle="warning-link",width=85,command=self.clear_all)
    ...
    class Frame3(tk.Frame):
        def __init__(self, parent):
            ...
            self.button1 = ttk.Button(self, text="Save & Quit",bootstyle="primary", command=self.save_and_quit_window) # Δημιουργώ ενα κουμπί "Save", το οποίο όταν πατηθεί αποθηκεύει ό,τι έχει γράψει ο χρήστης
            self.button1.grid(row=1, column=3, sticky="news", padx=555,pady=3) # Τοποθετώ το κουμπί στο πλαίσιο

            self.button2 = ttk.Button(self, text="Exit",bootstyle="primary", command=self.exit_window) # Δημιουργώ ένα κουμπί "Exit", το οποίο όταν πατηθεί κλείνει το παράθυρο
            self.button2.grid(row=1, column=1, sticky="news", padx=15,pady=3) # Τοποθετώ το κουμπί στο πλαίσιο
    ...
    root = ttk.Toplevel() # Δημιουργώ το παράθυρο, και βάζω ένα συγκεκριμένο theme
...
class WelcomePage():
    def __init__(self,root_welcomepage):
        ...
        self.b3 = ttk.Button(self.w,bootstyle="light",text='Entry',command = self.b3_pushed)
