...
def giannisapp():
    ...
    class App():
        def __init__(self,root):
            ...
            self.entrysave=[] #list that contains the value of each entrybox when you press the button save
    ...
    class Frame1(tk.Frame):
        def __init__(self, parent,app):
            ...
            for i in range(5): # Τοποθετώ μέσα σε μια σειρά τα παρακάτω widget για να αποφύγω την επανάληψη τους 
                ...
                self.entry = ttk.Entry(self, width=30, font=("Helvetica", 10),bootstyle="danger",textvariable=text)
            ...
            for i in range(5):
                ...
                self.app.entries.append(self.entry) # μια ενέργεια που προσθέτει το entry πεδίο στη λίστα self.entries. Αυτό το γίνεται για να διατηρηθεί η λίστα με όλα τα entry πεδία που δημιουργήθηκαν
        ...
        def char_limit(self, event): # Η συνάρτηση που βάζει όριο στους χαρακτήρες που μπορούν να πληκτρολογηθούν στα entry box.
            ...
            if len(input_str) > 13: # Ελέγχει εάν το μήκος του string είναι μεγαλύτερο των 15 χαρακτήρων
