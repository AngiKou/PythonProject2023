...
def giannisapp():
    ...
    class Frame2(tk.Frame):
        def __init__(self, parent, app):
            ...
            self.text = ttk.Text(
                self, font=("Helvetica", 10), width=80, height=23,)#textvariable=variabletoutext
    ...
    class Frame3(tk.Frame):
        ...
        def save_and_quit_window(self):
            ...
            creating_files.save_file(datepicked,self.app.entrysave,self.app.textvar)  # checkpoint
            self.master.destroy()
